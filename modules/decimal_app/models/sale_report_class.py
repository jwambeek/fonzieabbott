...
class Sale_Report_Class(models.Model):
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            l.x_studio_liters_per_unit_eg_03_for_300ml as liters_sold,
            count(*) * (l.x_studio_liters_per_unit_eg_03_for_300ml) as total_liters_sold,
            s.id as order_id
        """
        ...
        groupby_ = """
            ...
            l.x_studio_liters_per_unit_eg_03_for_300ml,
            s.name,
            s.date_order,
            s.partner_id,
            s.user_id,
